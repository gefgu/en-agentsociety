import { BLOCKS, ATTRIBUTE_TO_EMOJI, type BlockExecution, type TimelineDataPoint } from "../../pages/DailySchedule";
    ...
    <>
      <div style={{
        ...
        {columns.map((column, colIndex) => (
          <div key={colIndex} style={{ display: 'flex', flexDirection: 'column', minWidth: '320px' }}>
            {/* Column Header */}
            <div style={{
              fontSize: '32px',
              fontWeight: 'bold',
