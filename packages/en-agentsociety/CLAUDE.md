...
pip install -e packages/en-agentsociety
...
### CLI
```bash
en-agentsociety run --config <file.yaml>         # run simulation
en-agentsociety check --config <file.yaml>       # validate config
en-agentsociety ui --config <file.yaml>          # launch web UI
```
...
Files: `simulation/en_agentsociety.py`, `simulation/simulationengine.py`, `simulation/individualengine.py`
