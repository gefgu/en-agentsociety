...
from en_agentsociety.prompts.base import BasePrompt
from en_agentsociety.prompts.prompt_manager import PromptManager, ResponseMode, PromptResult
from en_agentsociety.cityagent.blocks.needs_block import (
    _find_complete_satisfaction_dict,
    _has_complete_satisfaction_dict,
)
from en_agentsociety.prompts.prompts.cognitionblock import CognitionEmotionUpdateAgentsociety
from en_agentsociety.prompts.prompts.economyblock import MonthPlanGoalCreationAgentsociety
from en_agentsociety.prompts.prompts.otherblock import OtherTimeEstimateAgentsociety
