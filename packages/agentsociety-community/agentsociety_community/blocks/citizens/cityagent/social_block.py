...
from en_agentsociety.cityagent.sharing_params import SocietyAgentBlockOutput
...
Please output the message in the following format:
{{"content": "message", "propagation_count": 1}}
        """
