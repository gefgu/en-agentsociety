...
```bash
uvicorn agentsociety.webapi.app:app --host 0.0.0.0 --port 8080 --reload
```

Or programmatically:

```python
from agentsociety.webapi.app import create_app
import uvicorn
...
```bash
agentsociety run --config my_experiment.yaml
